...
export default function NewFooter() {
    return (
        <footer className="bg-slate-900 text-white rounded-t-[60px] overflow-hidden shadow-[0_-20px_60px_-15px_rgba(0,0,0,0.3)]">
                    ...
                    <div>
                        ...
                        <div className="flex gap-4">
                            {['facebook', 'twitter', 'instagram', 'linkedin'].map((social) => (
                                <a key={social} href="#" className="w-10 h-10 bg-white/10 hover:bg-emerald-500 rounded-full flex items-center justify-center transition-colors">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            {['Home', 'About Us', 'Properties', 'Agents', 'Blog', 'Contact'].map((link) => (
                                <li key={link}><a href="#" className="text-slate-400 hover:text-emerald-400 transition-colors">{link}</a></li>
                            ))}
                        </ul>
                    </div>
