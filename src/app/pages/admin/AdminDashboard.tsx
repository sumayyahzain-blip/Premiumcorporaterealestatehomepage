...
export default function AdminDashboard() {
    ...
    return (
        <div className="min-h-screen bg-[#0f172a] pt-24 pb-12 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
                ...
                <div className="absolute bottom-[-10%] left-[-5%] w-[400px] h-[400px] rounded-full bg-emerald-500/5 blur-3xl pointer-events-none"></div>
            </div>
                ...
                {isLoading || !stats ? (
                    ...
                    <>
                        ...
                        {(stats.pendingApprovals > 0 || stats.pendingPayments > 0 || stats.maintenanceRequests > 0) && (
                            <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-8 shadow-lg">
                                <div className="flex items-center gap-3 mb-3">
